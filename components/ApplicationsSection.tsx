...
const items = ["acupuncture", "osteopathy", "wellness", "retail"] as const;
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {items.map((item) => (
            <div
              key={item}
              className="group rounded-2xl border border-border bg-card p-8 shadow-soft transition-all hover:border-primary/50 hover:shadow-card"
            >
