          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 flex items-center gap-4">
              ...
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-secondary text-muted-foreground transition-colors hover:bg-[#25D366] hover:text-white"
                aria-label="WhatsApp"
              >
